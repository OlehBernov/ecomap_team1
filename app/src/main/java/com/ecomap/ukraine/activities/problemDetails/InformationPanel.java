...
public class InformationPanel {
    ...
    public static final int MAIN_COLOR = 0xff004d40;
    ...
    public InformationPanel(final Activity activity, final Problem problem) {
        ...
        slidingUpPanelLayout = (SlidingUpPanelLayout) activity.findViewById(R.id.sliding_layout);
        slidingUpPanelLayout.setPanelSlideListener(new MyPanelSlideListener(activity, problem));
    ...
    private class MyPanelSlideListener implements SlidingUpPanelLayout.PanelSlideListener {
        public static final int TRANSPARENT_WHITE_COLOR = 0x00ffffff;
        public static final int COVERED_FADE_COLOR = 0xff004d40;
        public static final int TRANSPARENT_BLACK = 0x00000000;
        private final Activity activity;
        private final Problem problem;

        public MyPanelSlideListener(Activity activity, Problem problem) {
            this.activity = activity;
            this.problem = problem;
        }
...
//                hideFab();
            if (v > slidingUpPanelLayout.getAnchorPoint()) {
                slidingUpPanelLayout.setCoveredFadeColor(COVERED_FADE_COLOR);
...
//                isScrollDisable = (v != 1);
        ...
        private void setToolbarInitialState() {
            toolbar.setBackgroundColor(COVERED_FADE_COLOR);
        ...
        public void onPanelAnchored(View view) {
            scrollView.setVerticalScrollBarEnabled(false);
            slidingUpPanelLayout.setCoveredFadeColor(TRANSPARENT_BLACK);
            scrollView.fullScroll(ScrollView.FOCUS_UP);
            setToolbarInitialState();
            isScrollDisable = true;
        }
        ...
        private void rescaleText(float v) {
            float scale = (Math.max(v - COLLAPSE_OFFSET, 0) * 3);
        ...
        private void morphToAddButton() {
            ...
            fab.setBackgroundTintList(ColorStateList.valueOf(COVERED_FADE_COLOR));
            fab.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
